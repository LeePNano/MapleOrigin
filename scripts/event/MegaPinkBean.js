...
function start(eim) {
    ...
    var mob6 = MapleLifeFactory.getMonster(8820200);
...
function bomb(eim) {
    if (eim.getIntProperty("finished") < 1) {
        if (map.getSpawnedMonstersOnMap() < 40) {
            map.spawnMonsterOnGround(MapleLifeFactory.getMonster(8510200), new java.awt.Point(Randomizer.rand(-600, 600), -600));
        }
...
function monsterKilled(mob, eim) {
    if (mob.getId() >= 8820200 && mob.getId() <= 8820212) {
        eim.upgradePartyMedal(2500);
    }
